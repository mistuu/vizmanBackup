...
class InviteVIzRepo extends Component {
    createPDF=async()=> {
     
    let options = {
      html: this.html(),
      fileName: 'Invited Visitor',
      directory: 'documents',
      base64:true,
    };
    ...
    RNFS.moveFile(decodedURL, RNFS.DownloadDirectoryPath+"/Invited Visitor.pdf")
...
<div style="overflow-x:auto;">
   ...
   <th style="width:100%;text-align: center; border: 1px solid #000000; colspan="23"">Invited Visitor</th>
    ...
    try {
      let response = await axiosAuthGet(
        'Visitor/GetInvitedVisitors/' +
          ...
          this.props.LoginDetails.empID+"/"+true
      );
...
export default connect(mapStateToProps)(InviteVIzRepo);
