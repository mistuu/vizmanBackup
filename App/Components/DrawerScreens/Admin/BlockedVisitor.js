...
import { axiosPost, axPost } from '../../../utility/apiConnection';
import axios from 'axios';

class BlockedVisitors extends React.Component {
  constructor(props) {
    super(props);
  ...
  visitorListSuccess1 = AdmindVisitordtls => {
    ...
    console.log("Detils",i);
    this.props.VisitorDetails(AdmindVisitordtls[i]),
    this.props.BlockedViz({blockedId:1,status:0})
...
export default connect(mapStateToProps, mapDispatchToProps)(BlockedVisitors);
